...
## Javascript Assignments  [![Build Status](https://travis-ci.org/gzhegow2all/js-assignments.svg?branch=master)](https://travis-ci.org/gzhegow2all/js-assignments)

[![Greenkeeper badge](https://badges.greenkeeper.io/gzhegow2all/js-assignments.svg)](https://greenkeeper.io/)
...
* Edit local README.md file and update all links (just replace all occurrences of `'gzhegow2all'` with your account name).
...
```
* Open https://github.com/gzhegow2all/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/gzhegow2all/js-assignments/builds).
